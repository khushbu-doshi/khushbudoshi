    ...
    <div className="bg-background min-h-screen">
      ...
      <div className="pt-[80px]">
        <main className="max-w-[864px] mx-auto px-6 py-16">
          ...
          <VideoBox
            src="https://res.cloudinary.com/dnv5rxyhk/video/upload/q_auto/v1778789896/fortuna-insights_ppinwf.mp4"
            className="mb-16"
            padding="p-0"
          />
          ...
          <section id="legal-industry" className="mb-[117px] scroll-mt-[80px]">
            ...
            <BareImage
              src="https://res.cloudinary.com/dnv5rxyhk/image/upload/q_auto,f_auto/v1778789891/fortuna-insights-litigation-finance_g9mvmu.png"
          ...
          <section id="user-research" className="mb-[117px] scroll-mt-[80px]">
            ...
            {/* No background container */}
            <BareImage
              src="https://res.cloudinary.com/dnv5rxyhk/image/upload/q_auto,f_auto/v1778789895/userResearch_egqlay.jpg"
          ...
          <section id="user-flow" className="mb-[117px] scroll-mt-[80px]">
            ...
            {/* No background container */}
            <BareImage
              src="https://res.cloudinary.com/dnv5rxyhk/image/upload/q_auto,f_auto/v1778789893/userFlow_ddyyeu.png"
          ...
          <section id="prototypes" className="mb-[117px] scroll-mt-[80px]">
            ...
            <div className="flex flex-col gap-[73px]">
              ...
              <div>
                ...
                <VideoBox src="https://res.cloudinary.com/dnv5rxyhk/video/upload/q_auto/v1778789884/caseCollaboration_lbhez6.mov" />
              </div>
              ...
              <div>
                ...
                <ImageBox
                  src="https://res.cloudinary.com/dnv5rxyhk/image/upload/q_auto,f_auto/v1778789887/ApplyForFunding_ddxebw.jpg"
              ...
              <div>
                ...
                <VideoBox src="https://res.cloudinary.com/dnv5rxyhk/video/upload/q_auto/v1778789885/ai-chatbot_yfpouv.mov" />
              </div>
